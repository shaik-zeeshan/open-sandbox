...
Optional:
- `SANDBOX_SECRETS_KEY`: encrypts sandbox secret env values at rest; must be a raw 32-byte string or base64-encoded 32-byte key, and should remain unset unless secret env support is being configured
