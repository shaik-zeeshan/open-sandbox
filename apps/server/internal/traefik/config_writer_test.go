...
func TestReconcileWritesCoreAndWorkloadConfigs(t *testing.T) {
	...
	assertFileContains(t, filepath.Join(dir, "00-core.yaml"), "PathPrefix(`/api`) || PathPrefix(`/auth`)")
	assertFileNotContains(t, filepath.Join(dir, "00-core.yaml"), "Host(`app.lvh.me:3000`)")
